...
printids("new thread:");
	...
	EGL_NONE };
    	...
    	EGLSurface surface = eglCreateWindowSurface(_canvas->_display, _canvas->_config,
			(EGLNativeWindowType) _canvas->_wndType, NULL);
	if (surface == EGL_NO_SURFACE) {
		cout<<"create window surface error"<<std::endl;
		return EGL_FALSE;
	}
